...
Require the package with composer using the following command:
    ...
    composer require shahroz/laravel-fullcalendar
...
```php
Shahroz\LaravelFullcalendar\ServiceProvider::class,
```

And optionally create an alias:

```php
'Calendar' => Shahroz\LaravelFullcalendar\Facades\Calendar::class,
...
Alternatively, you can use an existing class and have it implement `Shahroz\LaravelFullcalendar\Event`. An example of an Eloquent model that implements the `Event` interface:

```php
class EventModel extends Eloquent implements \Shahroz\LaravelFullcalendar\Event
{
...
If you wish for your existing class to have event IDs, implement `\Shahroz\LaravelFullcalendar\IdentifiableEvent` instead. This interface extends `\Shahroz\LaravelFullcalendar\Event` to add a `getId()` method:

```php
class EventModel extends Eloquent implements \Shahroz\LaravelFullcalendar\IdentifiableEvent
{
...
```php
<?php
class CalendarEvent extends \Illuminate\Database\Eloquent\Model implements \Shahroz\LaravelFullcalendar\Event
{
	//...
...
$eloquentEvent = EventModel::first(); //EventModel implements Shahroz\LaravelFullcalendar\Event
